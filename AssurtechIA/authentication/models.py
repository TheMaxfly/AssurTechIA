...
class User(AbstractUser):
    ...
    role = models.CharField(
        max_length=30, choices=ROLE_CHOICES, verbose_name="Rôle", default=Customer
    )
...
class Prediction(models.Model):
    ...
    weight = models.IntegerField(
        validators=[MinValueValidator(20), MaxValueValidator(450)]
    )
    size = models.IntegerField(
        validators=[MinValueValidator(100), MaxValueValidator(260)]
    )
